      ...
      <div className='home__container container'>
        ...
        <div className='home__content'>
          <div className="home__content-data" >
            <h3 className='home__title' data-aos="fade-down" data-aos-delay="100">ARE YOU READY TO</h3>
            <h1 className='home__subtitle display-1 d-lg' data-aos="fade-down" data-aos-delay="200">REVOLUTIONIZE YOUR BUSINESS</h1>
            <hr className='home__line' data-aos="fade-right" data-aos-delay="500" />
            <p className='home__content-title lead' data-aos="fade-down" data-aos-delay="300">We specialize in Digital Transformation, aiming to elevate and expand your online presence. Our mission is to ensure you never miss an opportunity to connect with your customers and grow your business.</p>
            <div className="home__button-data">
              <button id='button1' data-aos="fade-up" data-aos-delay="400" onClick={togglePopup} className='btn btn-primary button button--flex home__Contactbutton'>Contact us</button>
              <button id='button2' data-aos="fade-up" data-aos-delay="500" onClick={handleButtonClick} className='btn btn-outline-primary button button--flex home__Readbutton'>Read More</button>
              <ConsultForm isPopupVisible={isPopupVisible} togglePopup={togglePopup} />
            </div>
          </div>
          <div className="home__content-image" data-aos="fade-up">
        ...
        <section className='home__features' data-aos="fade-up">
          <ul className='feature-list'  >
            <li className='feature-item'>
              <div className='feature-dot'></div>
              <div className='feature-content'>
                <h3 className='feature-title'>Intuitive Task Management:</h3>
                <p>Optimize your workflow with our intuitive project management software. Seamlessly create, assign, and track tasks to ensure every team member stays aligned with project objectives and deadlines.</p>
              </div>
            </li>
            <li className='feature-item'>
              <div className='feature-dot'></div>
        ...
        {/* grom business */}
        <section className='home__grom' data-aos="fade-up">
          <h1 className='home__grom-title'>How can NexGen innovations help you grow?</h1>
          <p className='home__grom-subtitle'>Every business has different needs. Be it designing a landing page or building a big e-commerce store, NexGen can help you with every tech challenge. That’s why they call us best IT company in India.</p>
          <div className='home__grom-content'>
            <div className='home__grom-data' data-aos="fade-up" data-aos-delay="50">
            ...
            <div className='home__grom-data' data-aos="fade-up" data-aos-delay="100">
            ...
            <div className='home__grom-data' data-aos="fade-up" data-aos-delay="150">
            ...
            <div className='home__grom-data' data-aos="fade-up" data-aos-delay="200">
            ...
            <div className='home__grom-data' data-aos="fade-up" data-aos-delay="250">
        ...
        {/* Service start */}
        <section className="home__service" data-aos="fade-up">
          <h1 className="home__service-title">Service</h1>
          <div className="home__service-content">
            <article className="card" data-aos="fade-up" data-aos-delay="50">
        ...
        <section className='Home__choose'>
          <div className='Home__whyChooseBlock'>
            <div className="home__chooseBlock1-content" data-aos="fade-up">
              <div className="chooseblock1-data1">
                <img src={bulbImage} alt="bulb" className='chooseIcon' />
                <h2>Business Strategy</h2>
                <p>Creating software that streamlines operations and drives business growth.</p>
              </div>
              <div className="chooseblock1-data2">
                <img src={clock} alt="bulb" className='chooseIcon' />
            ...
            <div className="home__chooseBlock3-content" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="chooseblock3-data2">
                <div className="chooseblock3-subpart1">
                  <img src={calendarImage} alt="bulb" className='chooseIcon' />
                  <h2>Delivery</h2>
                  <p>The effective purchasing and fast production departments enable us to deliver in time.</p>
                </div>
                <div className="chooseblock3-subpart2">
                  <img src={settingImage} alt="bulb" className='chooseIcon' />
        ...
        <section className='Home__hireBlock' data-aos="fade-up">
